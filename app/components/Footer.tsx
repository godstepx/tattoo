    ...
    <footer className="bg-primary text-white py-12">
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">{siteContent.siteInfo.title}</h3>
            <p className="mb-4 text-gray-300">
              Professionelle Tätowierungen in einer angenehmen und kreativen Atmosphäre.
            </p>
            <div className="flex space-x-4">
              <a 
                href={siteContent.siteInfo.socialMedia.instagram}
                target="_blank"
              ...
              <a 
                href={siteContent.siteInfo.socialMedia.facebook}
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-300 hover:text-white transition-colors"
              >
            ...
            <address className="not-italic text-gray-300">
              ...
              <p className="mb-2">
                ...
                <a href={`tel:${siteContent.siteInfo.phone}`} className="hover:text-white transition-colors">
                  {siteContent.siteInfo.phone}
                </a>
              </p>
              <p>
                <span className="font-semibold text-white mr-2">E-Mail:</span>
                <a href={`mailto:${siteContent.siteInfo.email}`} className="hover:text-white transition-colors">
                  {siteContent.siteInfo.email}
                </a>
              </p>
            </address>
          </div>
          ...
          <div>
            ...
            <div className="mt-6">
              <Link href="/kontakt" className="btn btn-outline border-white text-white hover:bg-white hover:text-primary">
                Kontaktiere uns
              </Link>
            </div>
          </div>
        ...
        <div className="border-t border-gray-700 mt-12 pt-8 text-center text-gray-400 text-sm">
          <p>© {currentYear} {siteContent.siteInfo.title}. Alle Rechte vorbehalten.</p>
